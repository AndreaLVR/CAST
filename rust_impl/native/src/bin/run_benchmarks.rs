...
fn main() {
    ...
    println!("Competitors:        {:?} (Always Global/Solid)", competitors); // Nota aggiunta
    ...
    for file_path in files_to_test {
        ...
        // ---------------------------------------------------------
        // Per i competitor, dobbiamo caricare il file intero in RAM.
        // Se CAST era solid, potremmo ottimizzare non rileggendo, ma per pulizia codice rileggiamo o usiamo una cache.
        // Qui assumiamo che se usi Chunked su CAST è per performance, ma per i competitor standard
        // vuoi comunque il confronto "Best Possible", quindi carichiamo il file intero.

        // Nota: Se il file è enorme (> RAM), questo crasherà, ma è quello che vuoi per il confronto "fair".
