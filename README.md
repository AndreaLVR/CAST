...
### 📥 [Download Latest Release](https://github.com/AndreaLVR/CAST/releases/tag/1.0.0)
...
> A pre-compiled **Beta Release** of the O(1) seeking engine is also available [here](https://github.com/AndreaLVR/CAST/releases/tag/0.2.0-beta) (look for files tagged `preview`).
...
<summary><strong>🔍 CLICK TO EXPAND THE FULL BENCHMARKS TABLE</strong></summary>
<br>
<img src="paper/images/rust_system_benchmarks.png" alt="Rust System Benchmarks" width="100%">
<br>
</details>
