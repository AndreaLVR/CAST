...
📦 **Compression Density**: Maximizes efficiency for Cold Storage & Archival by drastically reducing disk footprint, while simultaneously optimizing Bandwidth-Limited Transmission (e.g., Edge-to-Cloud logging). Ideally paired with high-ratio backends like LZMA2 to minimize infrastructure costs.
